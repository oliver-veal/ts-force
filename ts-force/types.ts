...
import { RestObject } from './rest/restObject.ts';
...
export type ExcludeNonQueryFields<T> = Omit<T, '_TYPE_' | 'attributes' | '_modified' | '__UUID'>;

// for constructing SObjects
export type ExcludeNonFields<T> = Omit<T, 'attributes' | '_modified' | '__UUID'>;
